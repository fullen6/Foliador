...
public class NumberToLetterConverter {
    ...
    public static void main(String[] args) {
        System.out.println(convertNumberToLetter("2101",LITERAL_MIL));
    }
     ...
     */
    public static String convertNumberToLetter(String number, int lieteralMil)
            throws NumberFormatException {
        return convertNumberToLetter(Double.parseDouble(number),lieteralMil);
    }
     ...
     */
    public static String convertNumberToLetter(double doubleNumber, int literalMil)
            throws NumberFormatException {
